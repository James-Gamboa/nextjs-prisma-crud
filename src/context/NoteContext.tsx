...
export const NotesProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  async function loadNotes() {
    ...
    if (!res.ok) {
      console.error("La solicitud no fue exitosa:", res.status);
      return;
    }
  ...
  async function createNote(note: CreateNote) {
    ...
    if (!res.ok) {
      console.error("La solicitud de creación de nota no fue exitosa:", res.status);
      return;
    }
    ...
    try {
      ...
      console.error("Error al analizar la respuesta JSON de creación de nota:", error);
    }
  }
